...
class HelloReply;
struct HelloReplyGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern HelloReplyGlobalsTypeInternal HelloReply_globals_;
extern const ::google::protobuf::internal::ClassDataFull HelloReply_class_data_;
#else
extern const HelloReplyGlobalsTypeInternal HelloReply_globals_;
...
/* @@protoc_insertion_point(class_definition:helloworld.HelloReply) */ {
 public:
  ...
  inline HelloReply(HelloReply&& from) noexcept : HelloReply(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const HelloReply& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<HelloReply>(&HelloReply_globals_);
  }
